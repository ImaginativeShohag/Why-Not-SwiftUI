...
final class NetworkKitTests: XCTestCase {
    ...
    func setProvider(
        ...
        let session = NetworkSession.create(
            ...
            mappedCertificates: ["example.com": [mockPEMKeyForExampleDotCom]]
        )
